...
class RepHead(nn.Module):
    ...
    def __init__(self, nc=80, ch=()):  # detection layer
        ...
        self.DBB = nn.ModuleList(nn.Sequential(RepConv(x, x, 3), RepConv(x, x, 3)) for x in ch)  # DySnakeConv
